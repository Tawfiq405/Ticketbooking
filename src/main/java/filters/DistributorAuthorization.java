...
/**
 * Servlet Filter implementation class DistributorAuthorization
 */

public class DistributorAuthorization extends HttpFilter implements Filter {
       
    /**
     * @see HttpFilter#HttpFilter()
     */
    public DistributorAuthorization() {
        super();
